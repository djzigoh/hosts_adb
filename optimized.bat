...
powershell -NoProfile -ExecutionPolicy Unrestricted -Command "Invoke-WebRequest -Uri '%URL%' -OutFile '%%i_2024_adb_block_with_login'"
powershell -NoProfile -ExecutionPolicy Unrestricted -Command "& './Remove-FirstSevenLines.ps1'" '%%i_2024_adb_block_with_login'" 
)
